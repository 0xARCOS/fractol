...
cd fract-ol/mandatory

# Clona la MiniLibX (versión Linux) en el directorio raíz del proyecto
cd ..
...
# Ejecuta el programa con el fractal deseado
./fractol mandelbrot
./fractol julia
./fractol lorenz
```
...
👉 [Guía MiniLibX](../docs/MiniLibX_GuiaCompleta.md)
...
|----|----------------------------------------|------------------------------------------------------------|
| 1  | [Ex_1.c](./exercises/Ex_1.c)           | Inicialización básica y creación de una ventana           |
| 2  | [Ex_2.c](./exercises/Ex_2.c)           | Captura de la tecla `ESC` para cerrar ventana             |
| 3  | [Ex_3.c](./exercises/Ex_3.c)           | Dibujo de píxeles usando `my_mlx_pixel_put()`             |
| 4  | [Ex_4.c](./exercises/Ex_4.c)           | Uso directo de `mlx_pixel_put()`                          |
| 5  | [Ex_5.c](./exercises/Ex_5.c)           | Dibujo de líneas con el algoritmo de Bresenham            |
| 6  | [Ex_6.c](./exercises/Ex_6.c)           | Generación de un degradado de color horizontal            |
| 7  | [Ex_7.c](./exercises/Ex_7.c)           | Movimiento de un cuadrado con las teclas de dirección     |
| 8  | [Ex_8.c](./exercises/Ex_8.c)           | Animación de rebote automático de un cuadrado             |
